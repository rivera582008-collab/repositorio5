...
FinAlgoritmo
// and indica que ambos elementos deben ser true para que sea verdadera
//or una debe ser verdadera
//not niega la expresion
// guardar el estado de contador y luego smar con su estad anterior
//